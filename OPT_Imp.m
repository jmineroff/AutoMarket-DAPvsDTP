...
for i = 1:n
    ...
    [X,FVAL,EXITFLAG(i,1),OUTPUT(i,1),LAMBDA(i,1)] ...
        = fmincon( @(x)( OBJ_Imp(x,e,a,t,w,f,cCoef,UCoef) ),...
          x0,...
          A,...
          B,...
          Aeq,...
          ...
          LB,...
          UB,...
          @(x)( NONLCON_Imp(x,e,a,t,w,f,c,ACoef,UCoef,cCoef) ),...
          opt );
...
set(get(gca,'YLabel'),'String','Portion of Runs completed')
